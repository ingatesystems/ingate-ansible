...
project = 'Fuego Ansible collections'
copyright = 'Ingate Systems AB'

title = 'Ingate Systems Ansible Collections Documentation'
html_short_title = 'Ingate Systems Ansible Collections Documentation'
